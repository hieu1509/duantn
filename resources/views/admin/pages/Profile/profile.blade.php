                    ...
                    <div class="row g-4">
                        <div class="col">
                            <div class="p-2">
                                ...
                                <p class="text-white text-opacity-75">Quản trị viên</p>
                            </div>
                        </div>
                    </div>
                    <!--end row-->
                                        ...
                                        <div class="col-xxl-9">
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <p> Đây là người quản trị của website bán lẻ thiết bị điện tử TechShop</p>
                                                    <div class="row">
                                                        <div class="col-6 col-md-4">
                                                            <div class="d-flex mt-4">
                                                                ...
                                                                <div class="flex-grow-1 overflow-hidden">
                                                                    <p class="mb-1">Tên gọi :</p>
                                                                    <h6 class="text-truncate mb-0">Admin / Quản trị viên</h6>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <!--end col-->
