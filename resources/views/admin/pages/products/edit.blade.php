                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input value="{{ $product->name }}" name="name" id="name" type="text"
                                        class="form-control" id="product-title-input" value=""
                                ...
                                <div>
                                    ...
                                    <textarea name="content" id="ckeditor-classic">{{ $product->content }}
                        </textarea>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <textarea name="description" id="description" class="form-control" placeholder="" rows="12">{{ $product->description }}</textarea>
                            </div>
                            <!-- end card body -->
                        </div>
                        <!-- end card -->
