                                    ...
                                    <table class="table table-nowrap align-middle" id="orderTable">
                                        <thead class="text-muted table-light">
                                            <tr class="text-uppercase">
                                                ...
                                                <th class="sort" data-sort="code">Mã đơn hàng</th>
                                                <th class="sort" data-sort="payment_type">Loại thanh toán</th>
                                                <th class="sort" data-sort="total_price">Tổng giá</th>
                                                <th class="sort" data-sort="user_name">Người dùng</th>
                                                <th class="sort" data-sort="promotion">Khuyến mãi</th>
                                                <th class="sort" data-sort="shipping">Vận chuyển</th>
                                                <th class="sort" data-sort="name">Tên khách hàng</th>
                                                <th class="sort" data-sort="address">Địa chỉ</th>
                                                <th class="sort" data-sort="money_total">Tổng tiền</th>
                                                <th class="sort" data-sort="phone">Số điện thoại</th>
                                                <th class="sort" data-sort="note">Ghi chú</th>
                                        ...
                                        <tbody class="list form-check-all">
                                            @foreach ($order as $item)
                                                <tr>
                                                    ...
                                                    <td class="id"><a href="apps-ecommerce-order-details.html" class="fw-medium link-primary">{{ $item->id }}</a></td>
                                                    <td class="code">{{ $item->code }}</td>
                                                    <td class="payment_type">{{ $item->payment_type }}</td>
                                                    <td class="total_price">{{ $item->total_price }} <small class="text-muted">{{ $item->currency }}</small></td>
                                                    <td class="user_name">{{ $item->user->name }}</td> <!-- Sửa thành hiển thị tên người dùng -->
                                                    <td class="promotion">{{ $item->promotion ? $item->promotion->name : 'Không có' }}</td>
                                                    <td class="shipping">{{ $item->shipping_id }}</td>
                                                    <td class="name">{{ $item->name }}</td>
                                                    <td class="address">{{ $item->address }}</td>
                                                    <td class="money_total">{{ $item->money_total }}</td>
