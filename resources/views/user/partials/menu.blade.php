<header id="masthead" class="site-header header-v2" style="background-image: none; ">
    <div class="col-full desktop-only">
        <div class="row">
                    ...
                    @foreach ($categories as $category)
                        <li class="yamm-tfw menu-item menu-item-has-children animate-dropdown dropdown-submenu">
                            <a title="{{ $category->name }}" data-toggle="dropdown" class="dropdown-toggle"
                                aria-haspopup="true" href="#">{{ $category->name }}<span class="caret"></span></a>
                                                            ...
                                                            <ul>
                                                                ...
                                                                @if ($category->subCategories->isNotEmpty())
                                                                    @foreach ($category->subCategories as $subCategory)
                                                                        <li><a href="{{ route('users.subcategories', $subCategory->id) }}">{{ $subCategory->name }}</a></li>
                                                                    @endforeach
                                                                @endif
                                                            </ul>
                                                    </div>
            ...
            <!-- .departments-menu -->
            <form class="navbar-search" method="get" action="{{ route('users.filter') }}">
        ...
        <div class="techmarket-sticky-wrap">
            <div class="row">
                <nav id="navbar-primary" class="navbar-primary text-center" aria-label="Navbar Primary"
                    data-nav="flex-menu">
                    <ul id="menu-navbar-primary" class="nav yamm">
                        ...
                        <li class="yamm-fw menu-item menu-item-has-children animate-dropdown dropdown">
                            <a title="Pages" data-toggle="dropdown" class="dropdown-toggle" aria-haspopup="true"
                                href="">Danh mục <span class="caret"></span></a>
                            <ul role="menu" class=" dropdown-menu">
                                <li class="menu-item menu-item-object-static_block animate-dropdown">
                                    <div class="yamm-content">
                                        <div class="tm-mega-menu">
                                            @foreach (['Laptop', 'Bàn phím', 'Chuột', 'Tai nghe', 'Loa', 'Phụ kiện laptop'] as $categoryGroup)
                                                <div class="widget widget_nav_menu">
                                                    <!-- Tạo từng nhóm danh mục như một phần riêng -->
                                                    @foreach ($categories as $category)
                                                    <ul class="menu">
                                                        <!-- Duyệt qua danh mục chính -->
                                                        @if (Str::contains($category->name, $categoryGroup))
                                                            ...
                                                            @if ($category->subCategories->isNotEmpty())
                                                                @foreach ($category->subCategories as $subCategory)
                                                                    <li class="menu-item">
                                                                        <a
                                                                            href="{{ route('users.subcategories', $subCategory->id) }}">{{ $subCategory->name }}</a>
                                                                        <!-- Danh mục con -->
                                                                    </li>
                                                                @endforeach
                                                            @endif
                        ...
                        {{-- <li class="menu-item animate-dropdown">
                            <a title="ACCESORIES" href="product-category.html"></a>
                        </li>
                                                            ...
                                                            <div class="kc_text_block">
                                                                <ul>
                                                                    ...
                                                                    <li><a href="shop.html">Home Entertainment
                                                                            Systems</a></li>
                                                                    <li><a href="shop.html">MP3 & Media Players</a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                            <!-- .kc_text_block -->
